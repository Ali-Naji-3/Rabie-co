...
@section('content')
	...
	<!--Contact area
============================================= -->
	<section class="reveal contact-area">
		<div class="container-fluid custom-container">
			<div class="reveal section-heading pb-30 text-center">
			...
			<div class="row justify-content-center">
				...
				<div class="reveal col-lg-10 col-xl-8 mb-5">
			...
			<div class="row justify-content-center">
				<div class="reveal col-lg-10 col-xl-8">
					<div class="contact-info-wrapper" style="background: #f8f9fa; padding: 40px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
						<h4 class="reveal" style="color: #1b1b18; font-size: 24px; font-weight: 700; margin-bottom: 30px; text-align: center; border-bottom: 3px solid #000000; display: inline-block; padding-bottom: 10px; width: 100%; text-align: center;">Contact Information</h4>
						
						<div class="row" style="margin-top: 30px;">
							<!-- Phone -->
							@if($siteSettings->phone)
							<div class="reveal col-md-6 col-lg-4 mb-4">
