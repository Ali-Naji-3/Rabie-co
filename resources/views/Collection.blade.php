								...
								<li class="has-child"><a href="index.html">Men</a>
									<div class="mega-menu">
										...
										<div class="mega-catagory mega-img per-30">
											<a href="#"><img src="media/images/banner/mmb1.jpg') }}" alt=""></a></a>
										</div>
										<div class="mega-catagory mega-img per-30">
											<a href="#"><img src="media/images/banner/mmb2.jpg') }}" alt=""></a></a>
										</div>
									</div>
								</li>
									...
									<div class="mega-menu five-col">
										...
										<div class="mega-product">
											<div class="sin-product">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/10.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">High-Low Dresses</a></h5>
													<span>$60.00</span>
												</div>
											</div>
										</div>
										<div class="mega-product">
											<div class="sin-product">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/11.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Empire Dresses</a></h5>
													<span>$10.00</span>
												</div>
											</div>
										</div>
										<div class="mega-product">
											<div class="sin-product">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/12.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Bodycon Dresses</a></h5>
													<span>$40.00</span>
												</div>
											</div>
										</div>
										<div class="mega-product">
											<div class="sin-product">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/13.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
									...
									<div class="row">
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp1.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Layered Dresses</a></h5>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp2.jpg') }}" alt=""></a>
												</div>
												<span class="new-tag">NEW!</span>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Dungaree Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp3.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Cape Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp4.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Shift Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp5.jpg') }}" alt=""></a>
												</div>
												<span class="new-tag">NEW!</span>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Spaghetti Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp6.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">T-shirt Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												<div class="pro-img">
													<a href="{{ route('product') }}"><img src="{{ asset('media/images/product/sp7.jpg') }}" alt=""></a>
												</div>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Tulle Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												...
												<span class="new-tag">NEW!</span>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Wrap Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												...
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Bandeau Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												...
												<span class="new-tag">NEW!</span>
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Sheath Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-sm-6 col-xl-3">
											<div class="sin-product style-two">
												...
												<div class="mid-wrapper">
													<h5 class="pro-title"><a href="{{ route('product') }}">Blouson Dresses</a></h5>
													<div class="color-variation">
														<ul>
															<li><i class="fas fa-circle"></i></li>
															<li><i class="fas fa-circle"></i></li>
										...
										<div class="col-xl-9">
											...
											<div class="sin-product list-pro">
												<div class="row">
													...
													<div class="col-md-7 col-lg-6 col-xl-8">
														<div class="list-pro-det">
															<h5 class="pro-title"><a href="{{ route('product') }}">Pencil Dresses</a></h5>
															<span>$387</span>
															<div class="rating">
																<ul>
																	<li><a href="#"><i class="fas fa-star"></i></a></li>
											...
											<div class="sin-product list-pro">
												<div class="row">
													...
													<div class="col-md-7 col-lg-6 col-xl-8">
														<div class="list-pro-det">
															<h5 class="pro-title"><a href="{{ route('product') }}">Asymmetric Dresses</a></h5>
															<span>$387</span>
															<div class="rating">
																<ul>
																	<li><a href="#"><i class="fas fa-star"></i></a></li>
											...
											<div class="sin-product list-pro">
												<div class="row">
													...
													<div class="col-md-7 col-lg-6 col-xl-8">
														<div class="list-pro-det">
															<h5 class="pro-title"><a href="{{ route('product') }}">Trench Dresses</a></h5>
															<span>$387</span>
															<div class="rating">
																<ul>
																	<li><a href="#"><i class="fas fa-star"></i></a></li>
											...
											<div class="sin-product list-pro">
												<div class="row">
													...
													<div class="col-md-7 col-lg-6 col-xl-8">
														<div class="list-pro-det">
															<h5 class="pro-title"><a href="{{ route('product') }}">Bandage Dresses</a></h5>
															<span>$387</span>
															<div class="rating">
																<ul>
																	<li><a href="#"><i class="fas fa-star"></i></a></li>
					...
					<div class="col-12 col-sm-6 col-md-6 col-lg-3">
						<div class="footer-widget style-two">
							...
							<div class="footer-instagram">
								<ul>
									<li><a href="#"><img src="media/images/instagram/6.jpg') }}" alt=""></a></a></li>
									<li><a href="#"><img src="media/images/instagram/7.jpg') }}" alt=""></a></a></li>
									<li><a href="#"><img src="media/images/instagram/8.jpg') }}" alt=""></a></a></li>
									<li><a href="#"><img src="media/images/instagram/9.jpg') }}" alt=""></a></a></li>
									<li><a href="#"><img src="media/images/instagram/10.jpg') }}" alt=""></a></a></li>
									<li><a href="#"><img src="media/images/instagram/11.jpg') }}" alt=""></a></a></li>
								</ul>
							</div>
						</div>
					</div>
