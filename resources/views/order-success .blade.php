				...
				<div class="row justify-content-center">
					<div class="col-xl-8 col-lg-10">
						...
						<div class="success-card" style="background: #fff; border-radius: 20px; padding: 60px 40px; text-align: center; box-shadow: 0 20px 60px rgba(0, 0, 0, 0.1); border: 3px solid #FFD700; position: relative; overflow: hidden;">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="detail-item" style="margin-bottom: 15px;">
											...
											<span style="color: #666; font-size: 16px; margin-left: 10px; text-transform: capitalize;">{{ $order->payment_method }}</span>
										</div>
										<div class="detail-item" style="margin-bottom: 15px;">
							...
							<!-- Next Steps -->
							<div class="next-steps" style="background: linear-gradient(135deg, #FFD700 0%, #FFA500 100%); border-radius: 15px; padding: 30px; margin: 40px 0; color: #000;">
								<h4 style="color: #000; font-size: 20px; font-weight: 700; margin-bottom: 15px; text-transform: uppercase;">
								...
								<div class="row">
									<div class="col-md-6 mb-3">
										<a href="{{ route('collection') }}" 
										   style="display: block; background: #000; color: #FFD700; padding: 15px 30px; text-decoration: none; border-radius: 10px; font-weight: 600; font-size: 16px; text-transform: uppercase; letter-spacing: 1px; transition: all 0.3s ease; border: 2px solid #000;"
									...
									<div class="col-md-6 mb-3">
										<a href="{{ url('/') }}" 
										   style="display: block; background: #FFD700; color: #000; padding: 15px 30px; text-decoration: none; border-radius: 10px; font-weight: 600; font-size: 16px; text-transform: uppercase; letter-spacing: 1px; transition: all 0.3s ease; border: 2px solid #FFD700;"
